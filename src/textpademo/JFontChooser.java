...
class FontChooserDialog extends JDialog {
    ...
    private final JTextField textFieldNames;     //campo de texto para el nombre del fuente
    private final JTextField textFieldStyles;    //campo de texto para el estilo del fuente
    private final JTextField textFieldSizes;     //campo de texto para el tamaño del fuente
    private final JList listFontNames;     //lista para nombres de fuente
    private final JList listFontStyles;    //lista para estilos de fuente
    private final JList listFontSizes;     //lista para tamaños de fuente
    private final JLabel textExample;    //etiqueta que muestra un ejemplo del fuente seleccionado
